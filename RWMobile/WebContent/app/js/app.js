...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, appRequires, helper) {
  ...
  $urlRouterProvider.otherwise('/app/table-ngtable');
  ...
  $stateProvider
    ...
    .state('app.table-ngtable', {
        url: '/table-ngtable',
        templateUrl: helper.basepath('table-ngtable-properties.html'),
        controller: 'NullController',
...
function NGTableCtrl($scope, $filter, ngTableParams, $resource, $timeout, ngTableDataService) {
  ...
  var data = [
      {name: "Promenade",  City: "Atlanta", State: "GA"   },
      {name: "Idlewylde 1", City: "Atlanta", State: "GA"},
      {name: "Vizcaya",   City: "Atlanta", State: "GA" },
      {name: "Coventry",   City: "Atlanta", State: "GA"},
      {name: "Longwood",   City: "Atlanta", State: "GA"},
      {name: "Lexington", City: "Atlanta", State: "GA"},
      {name: "Saxon",  City: "Atlanta", State: "GA"},
      {name: "East Lake",  City: "Atlanta", State: "GA"   },
      {name: "Halstead",   City: "Atlanta", State: "GA" },
      {name: "Reserve @ Deerwood",City: "Atlanta", State: "GA" },
      {name: "Audubon Village", City: "Tampa", State: "FL" },
      {name: "Ashley Mill", City: "Atlanta", State: "GA"  },
      {name: "Auburn Glen",   City: "Atlanta", State: "GA" },
      {name: "Bristol Oaks", City: "Atlanta", State: "GA" },
      {name: "Preserve at Deerpark",  City: "Orlando", State: "FL"  },
      {name: "Legacy at Fort Clark",  City: "Atlanta", State: "GA"  },
      {name: "Clifton Glen",   City: "Atlanta", State: "GA" }
  ];
  ...
  vm.changeSelection = function(prop) {
      // console.info(user);
  };
